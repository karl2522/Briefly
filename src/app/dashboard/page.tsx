...
import { BookOpen, Bot, Brain, ChevronDown, FileText, LogOut, Send, Upload, User } from 'lucide-react'
        ...
        <div className="mb-8">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Welcome back! Here&apos;s what&apos;s happening with your AI study tools.
            </p>
          </div>
        </div>
            ...
            <Card className="bg-white border-0 shadow-lg h-[700px] flex flex-col">
              <CardHeader className="pb-4 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold text-gray-900">AI Study Assistant</CardTitle>
                  ...
                  <Button variant="outline" className="w-full justify-start h-auto p-4 cursor-pointer hover:bg-purple-50">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="font-medium text-gray-900">Create Note</div>
                        <div className="text-sm text-gray-600">Start writing or upload</div>
                      </div>
                    </div>
                  </Button>
                </Link>
                ...
                <Link href="/flashcards" className="block">
                  <Button variant="outline" className="w-full justify-start h-auto p-4 cursor-pointer hover:bg-blue-50">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="font-medium text-gray-900">Study Flashcards</div>
                        <div className="text-sm text-gray-600">AI-generated cards</div>
                      </div>
                    </div>
                  </Button>
                </Link>
                  ...
                  <Button variant="outline" className="w-full justify-start h-auto p-4 cursor-pointer hover:bg-orange-50">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-sm text-gray-600">Process documents</div>
                      </div>
                    </div>
                  </Button>
                </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/notes" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">AI Notes</a></li>
                <li><a href="/flashcards" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">AI Flashcards</a></li>
                <li><a href="/notes" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">File Upload</a></li>
                <li><a href="/notes" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">AI Summarizer</a></li>
              </ul>
            </div>
